...
AGE_BASED_RULES: list[tuple[int, int | None, str, str, int, str, str]] = [
    ...
    (
        26,
        None,
        "HPV Vaccine (if unvaccinated)",
        "Gardasil 9 — up to age 45",
        0,
        "medium",
        "vaccination",
    ),
...
class PreventiveCareService:
    ...
    async def _get_overdue_followups(self, member_id: UUID, today: date) -> list[dict]:
